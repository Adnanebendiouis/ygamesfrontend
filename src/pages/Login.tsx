    ...
    <div className='main'>
      <div className="wrapper">
        <form onSubmit={handleLogin}>
          ...
          <div className='c0'>
            <div className='c1' onClick={() => navigate('/login')}><p>Se connecter</p></div>
            <div className='c2' onClick={() => navigate('/register')}><p>S'inscrire</p></div>
          </div>
          ...
          <div className="remember-forget">
            <Link to="/forgot-password" style={{ fontWeight: '500', fontSize: '14px' }}>Mot de passe oublié ?</Link>
          </div>
          <div className="register-link">
            <p>Nouveau sur YGAMES ? <Link to="/register"><span>Créez un compte</span></Link></p>
          </div>
        </form>
      </div>
    </div>
